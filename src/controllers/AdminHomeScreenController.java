...
public class AdminHomeScreenController implements Initializable {
    ...
    private static final String USERS_MANAGER = "./../views/users-manager.fxml";
    private static final String PROVIDERS_MANAGER = "./../views/providers-manager.fxml";
    //private static final String INVOICES_MANAGER = "./../views/invoices-manager.fxml";
    private static final String NOTIFICATIONS_MANAGER = "./../views/notifications-manager.fxml";

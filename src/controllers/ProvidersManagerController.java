...
public class ProvidersManagerController implements Initializable {
    ...
    private final FXMLLoader addProviderLoader = new FXMLLoader(getClass().getResource("./../views/add-provider.fxml"));
    ...
    private void newProviderOnClick(MouseEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("./../views/add-provider.fxml"));
